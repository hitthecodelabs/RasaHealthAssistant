...
class AllUser(AbstractUser):
    ...
    user_type = models.CharField(
        max_length=11, choices=UserType.choices, default=UserType.doctor)
    ...
    current_address = models.TextField(
        _("current address"), null=True, blank=True)
    permanent_address = models.TextField(
        _("permanent address"), null=True, blank=True)
    id_number = models.CharField(
        _("ID Number"), max_length=10, null=True, blank=True)
