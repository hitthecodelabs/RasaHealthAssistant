...
class AllUserUserCreationForm(UserCreationForm):
    ...
    class Meta:
        model = AllUser
        fields = ("first_name", 'id_number', "gender", "age",
                  "user_type", "last_name", "username", "email")
    ...
    def __init__(self, *args: Any, **kwargs: Any) -> None:
        ...
        self.helper.layout = Layout(
            ...
            Row(Column('id_number')), Column('age'),
            Row(Column('first_name'), Column('last_name')),
            Row(Column('username'), Column('email')),
            Row(Column('password1'), Column('password2')),
            Div(Submit('submit', 'Submit', css_class='btn col-4 btn-success'),
